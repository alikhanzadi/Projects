...
def cluster_results(reduced_data, preds, centers, pca_samples, sample_values):
    '''
    ...
    for index, point in zip(sample_values, pca_samples):
		plt.annotate(str(index),xy=(point[0]+.2,point[1]-.02))
